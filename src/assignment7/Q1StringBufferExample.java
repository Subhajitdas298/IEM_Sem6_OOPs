...
public class Q1StringBufferExample {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("sbuf current capacity : " + sbuf.capacity());
        System.out.println("sbuf char at 7 before : " + sbuf.charAt(7));
        sbuf.setCharAt(7, 'i');
        System.out.println("sbuf char at 7 after : " + sbuf.charAt(7));
        sbuf.setCharAt(7, 'o');
        System.out.println("sbuf char at 7 after 2nd change : " + sbuf.charAt(7));
